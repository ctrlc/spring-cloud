 ...
 * the License.
 */
package com.sa.cloud.center.system.generation;
...
public class CodeGeneration {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://rm-bp12m3yhq3w7mvv27ho.mysql.rds.aliyuncs.com:3306/spring-cloud?characterEncoding=UTF-8");
...
//        strategy.setSuperServiceImplClass(null);
        ...
        pc.setParent("com.sa.cloud.center.system");
