...
public abstract class WebUtils {
    ...
    public static final int DEFAULT_CONNECT_TIMEOUT = 3 * 60 * 1000;
    ...
    public static String doPost(String url, String ctype,
            ...
            throws IOException {
        return doPost(url, ctype, content.toString().getBytes(DEFAULT_CHARSET),
                connectTimeout, readTimeout);
    }

    public static String doPost(String url, String ctype, String content,
                                int connectTimeout, int readTimeout) throws IOException {
        return doPost(url, ctype, content.getBytes(DEFAULT_CHARSET), connectTimeout,
                readTimeout);
    }

    public static String doPost(String url, String ctype, String content)
            throws IOException {
        return doPost(url, ctype, content.getBytes(DEFAULT_CHARSET), DEFAULT_CONNECT_TIMEOUT,
    ...
    public static String doGet(String url, Map<String, String> params)
            throws IOException {
        return doGet(url, params, DEFAULT_CHARSET, DEFAULT_CONNECT_TIMEOUT, DEFAULT_READ_TIMEOUT);
    }
    ...
    public static String uploadSingle(String url, MultipartEntity reqEntity) {
        ...
        try {
            ...
            log.error(String.format("<%s> 方法 %s 上传异常...", "FileUploadUtil", "uploadSingle"), e);
        } finally {
            if (httpClient != null) {
